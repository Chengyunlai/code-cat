import { SourceDocument } from "../ports";
...
function refineDeclaration(document: SourceDocument, declarationLine: number): number {
...
function clampLineIndex(document: SourceDocument, value: number): number {
